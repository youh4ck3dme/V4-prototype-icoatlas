    ...
    async def fetch_company(self, cegjegyzek_szam: str) -> Company:
        ...
        for attempt in range(1, max_attempts + 1):
            try:
                ...
                logger.warning(f"NAVPlaywrightService: Attempt {attempt}/{max_attempts} timed out: {e}")
                ...
                logger.warning(f"NAVPlaywrightService: Attempt {attempt}/{max_attempts} failed: {e}")
                if attempt == max_attempts:
