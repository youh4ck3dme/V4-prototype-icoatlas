...
const Register = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200">Pripojte sa k iCOAtlas už dnes</p>
        </div>
