    ...
    async def fetch_company(self, nip_or_krs: str) -> Company:
        ...
        for attempt in range(1, max_attempts + 1):
            try:
                ...
                logger.warning(f"KRSPlaywrightService: Attempt {attempt}/{max_attempts} timed out: {e}")
                ...
                logger.warning(f"KRSPlaywrightService: Attempt {attempt}/{max_attempts} failed: {e}")
                if attempt == max_attempts:
