          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <div className="prose prose-slate max-w-none">
              <p className="text-sm text-slate-500 mb-8">
                <strong>Platné od:</strong> December 2024
                <br />
                <strong>Verzia:</strong> 1.1
                <br />
                <strong>Prevádzkovateľ:</strong> [Názov s.r.o.], IČO: [IČO],
                Sídlo: [Adresa]
              </p>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-slate-900 mb-4">
                  2. Dve skupiny dotknutých osôb
                </h2>

                <h3 className="text-xl font-semibold text-slate-800 mb-3">
                  2.1. Registrovaní užívatelia (Klienti)
                </h3>
                <p className="text-slate-700 leading-relaxed mb-4">
                  Osobné údaje registrovaných užívateľov (e-mail, meno,
                  fakturačné údaje) spracúvame na základe{" "}
                  <strong>súhlasu</strong> a <strong>výkonu zmluvy</strong>{" "}
                  (poskytovanie služby).
                </p>
                <p className="text-slate-700 leading-relaxed">
                  <strong>Účel spracovania:</strong> Poskytovanie služby,
                  fakturácia, komunikácia, technická podpora.
                </p>
                ...
                <p className="text-slate-700 leading-relaxed mb-4">
                  ...
                  Platforme, ale ich údaje sa zobrazujú v grafoch.
                </p>
                <p className="text-slate-700 leading-relaxed">
                  <strong>Právny základ:</strong>{" "}
                  <strong>Oprávnený záujem (Legitimate Interest)</strong>
                  podľa čl. 6(1)(f) GDPR.
                </p>
              </section>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-slate-900 mb-4">
                  3. Právny základ pre "scrapované osoby"
                </h2>
                <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4">
                  ...
                  <ul className="list-disc list-inside text-blue-700 space-y-1 ml-4">
                    <li>
                      Spracúvanie verejne dostupných údajov z obchodných
                      registrov
                    </li>
                ...
                <p className="text-slate-700 leading-relaxed">
                  ...
                  ale z oficiálnych zdrojov, ktoré sú prístupné každému.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                  <li>
                    <strong>Právo na prístup:</strong> Môžete požiadať o
                    informácie, aké údaje o vás spracúvame.
                  </li>
                  <li>
                    <strong>Právo na opravu:</strong> Môžete požiadať o opravu
                    nepresných údajov.
                  </li>
                  <li>
                    <strong>Právo na výmaz:</strong> Môžete požiadať o výmaz
                    údajov (pozri nižšie).
                  </li>
                  <li>
                    <strong>Právo na námietku:</strong> Môžete namietať proti
                    spracovaniu na základe oprávneného záujmu.
                  </li>
                  <li>
                    <strong>Právo na obmedzenie spracovania:</strong> Môžete
                    požiadať o dočasné pozastavenie spracovania.
                  </li>
                  <li>
                    <strong>Právo na prenosnosť:</strong> Môžete požiadať o
                    export vašich údajov.
                  </li>
                </ul>

                <div className="bg-amber-50 border-l-4 border-amber-400 p-4 mt-4">
                  <p className="text-amber-800 text-sm mb-3">
                    <strong>Dôležité pre osoby v grafoch:</strong> Ak sa vaše
                  ...
                  <div className="bg-white p-3 rounded mt-3">
                    ...
                    <ol className="list-decimal list-inside text-amber-800 text-xs space-y-1 ml-2">
                      ...
                      <li>
                        Uveďte vaše meno, dátum narodenia a IČO spoločnosti, kde
                        sa zobrazujete
                      </li>
                      <li>
                        Uveďte dôvod žiadosti (voliteľné, ale pomôže pri
                        posúdení)
                      </li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                  <li>
                    <strong>Registrovaní užívatelia:</strong> Údaje sa
                    uchovávajú počas trvania účtu a 3 roky po jeho zrušení
                    (kvôli daňovým povinnostiam).
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    s TTL 24 hodín pre optimalizáciu výkonu.
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                  <li>
                    <strong>Poskytovatelia cloudových služieb:</strong> Hosting,
                    databázy (napr. AWS, Azure) - na základe zmlúv o spracovaní
                    údajov.
                  </li>
                  <li>
                    <strong>Platobné brány:</strong> SumUp (len pre fakturačné
                    údaje registrovaných užívateľov).
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Právne povinnosti:</strong> Ak to vyžaduje zákon
                    alebo súdny príkaz.
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Pre otázky týkajúce sa ochrany osobných údajov, výmazu údajov
                  alebo námietok kontaktujte:
                </p>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-slate-900 mb-4">
                  9. Zmeny v týchto zásadách
                </h2>
                <p className="text-slate-700 leading-relaxed">
                  Tieto zásady môžeme meniť. O zmene budeme informovať
                  registrovaných užívateľov e-mailom a zverejníme novú verziu na
                  tejto stránke.
                </p>
              </section>
            </div>
